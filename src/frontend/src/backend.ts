...
export class Backend implements backendInterface {
    ...
    async getConsultantProfile(): Promise<ConsultantProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getConsultantProfile();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServicesByCategory(): Promise<Array<Service>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServicesByCategory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
